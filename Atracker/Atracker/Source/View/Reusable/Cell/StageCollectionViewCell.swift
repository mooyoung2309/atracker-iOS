...
class StageCollectionViewCell: BaseCollectionViewCell, View {
    typealias Reactor = StageCollectionViewCellReactor
    ...
    func bind(reactor: Reactor) {
        ...
        circleLabel.text = "\(reactor.currentState.order ?? 0 + 1)"
    }
}
