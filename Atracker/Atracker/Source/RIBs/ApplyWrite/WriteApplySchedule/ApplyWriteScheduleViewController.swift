...
protocol ApplyWriteSchedulePresentableListener: AnyObject {
    typealias Action = ApplyWriteScheduleInteractor.Action
    typealias State = ApplyWriteScheduleInteractor.State
...
final class ApplyWriteScheduleViewController: BaseNavigationViewController, ApplyWriteSchedulePresentable, ApplyWriteScheduleViewControllable {
    
    weak var listener: ApplyWriteSchedulePresentableListener?
...
//
//        calendarView.prevCollectionView.reloadData()
//        calendarView.currentCollectionView.reloadData()
//        calendarView.nextCollectionView.reloadData()
    }
...
//        calendarView.scrollView.contentOffset.x = selfView.scrollView.frame.width
    }
...
//        calendarView.prevCollectionView.delegate = self
//        calendarView.prevCollectionView.dataSource = self
//        calendarView.currentCollectionView.delegate = self
//        calendarView.currentCollectionView.dataSource = self
//        calendarView.nextCollectionView.delegate = self
//        calendarView.nextCollectionView.dataSource = self
    }
