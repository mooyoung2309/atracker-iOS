...
class ApplyEditView: BaseView {
    ...
    let awiatButton = FixSizedRoundButton(size: CGSize(width: 65, height: 26), title: "대기중", backgroundColor: .backgroundGray, tintColor: .gray3, selectedColor: .red)
    let failButton = FixSizedRoundButton(size: CGSize(width: 65, height: 26), title: "불합격", backgroundColor: .backgroundGray, tintColor: .gray3, selectedColor: .red)
    let passButton = FixSizedRoundButton(size: CGSize(width: 65, height: 26), title: "합격", backgroundColor: .backgroundGray, tintColor: .gray3, selectedColor: .red)
    ...
    let deleteButton = FixSizedRoundButton(size: CGSize(width: 65, height: 26), title: "삭제", backgroundColor: .backgroundGray, tintColor: .gray3, selectedColor: .red)
    let upButton = FixSizedRoundButton(size: CGSize(width: 26, height: 26), image: UIImage(systemName: "chevron.up"), backgroundColor: .backgroundGray, tintColor: .gray3, selectedColor: .red)
    let downButton = FixSizedRoundButton(size: CGSize(width: 26, height: 26), image: UIImage(systemName: "chevron.down"), backgroundColor: .backgroundGray, tintColor: .gray3, selectedColor: .red)
