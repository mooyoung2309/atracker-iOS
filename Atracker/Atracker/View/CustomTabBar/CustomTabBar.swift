...
final class CustomTabBar: UIStackView {
    ...
    private let profileItem = CustomItemView(with: .blog, index: 0)
    private let searchItem = CustomItemView(with: .application, index: 1)
    private let favoriteItem = CustomItemView(with: .calendar, index: 2)
